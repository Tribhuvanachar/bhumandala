...
Run:  python tools/dvaitavedanta/verify_extract.py --data data/darshana/vedanta/dvaita/DvaitaVedantaIn
"""
...
def main(argv=None):
    ...
    parser.add_argument("--data", default="data/darshana/vedanta/dvaita/DvaitaVedantaIn")
