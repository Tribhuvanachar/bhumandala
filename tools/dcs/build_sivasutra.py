...
Landed in data/agama/pancharatra/shaiva_agama/data.json -- an existing,
previously-empty ("Shaiva Agama") taxonomy leaf found while scoping how far
the DCS pilot could scale (see PENDING.md, 23 Aug entry): no placement
...
def main():
    count, chapters = build_generic_import(
        ...
        note=(
            ...
            "See PENDING.md for the DCS integration scoping decision "
