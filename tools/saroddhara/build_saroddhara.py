...
Reads <work>/pages_merged.json (tools/saroddhara/ocr_merge.py) and the Vision page text, and writes:
  dge/data/darshana/vedanta/dvaita/DvaitaVedantaIn/later_acharyas/bhagavata_saroddhara/
...
OUT_REL = "dge/data/darshana/vedanta/dvaita/DvaitaVedantaIn/later_acharyas/bhagavata_saroddhara"
