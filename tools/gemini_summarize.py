...
SYSTEM_INSTRUCTION_BATCH = (
    ...
    "individual words with sandhi resolved, in Devanagari, words separated "
    "by spaces; (2) anvaya -- the same words rearranged into plain prose "
    "(subject-object-verb) word order, in Devanagari, to aid "
