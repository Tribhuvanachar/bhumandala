...
- **Grantha acquisition list dictated 18 Aug 2026 — 14 lines to source and load, plus a two-way Veda↔saint linking requirement that is half-built. Several titles came through a voice transcription garbled; my readings are recorded beside the raw words rather than silently corrected, and the three flagged ones need the project lead's own confirmation before anyone goes hunting for a text.** Nothing here is sourced yet — this is the wanted-list, not a status report.
  ...
  | "Brihati Sahasra" | Bṛhatī Sahasra — the thousand bṛhatī-metre Pavamāna verses of RV IX | **medium — confirm**, especially whether the wanted item is the text itself or a vyākhyāna on it | `vedas/` |
