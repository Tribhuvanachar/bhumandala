...
(function () {
  ...
  var TABLE = [
    ...
    { key: 'smv', label: 'सुमध्वविजयः', kind: 'shloka', levels: 2, path: 'kavya_alankara/sumadhva_vijaya/sarga_{1}', range: [1, 16], example: 'smv1.5 → sarga 1, śloka 5' },
    { key: 'rgv', label: 'राघवेन्द्रविजयः', kind: 'shloka', levels: 2, path: 'kavya_alankara/raghavendra_vijaya/sarga_{1}', range: [1, 20], example: 'rgv1.5' },
    { key: 'pns', label: 'प्रह्लादकृतनृसिंहस्तोत्रम्', kind: 'shloka', levels: 1, path: 'stotra/PrahladaKrutaNarasimha', example: 'pns5 → śloka 5' },
